...
export default function Sidebar({
  ...
  return (
    <>
      {/* Mobile Top Navigation Bar (Shown on small screens < md) */}
      ...
      <aside className={`
        ...
        w-64 bg-white border-r border-slate-200/80 flex flex-col justify-between p-4 flex-shrink-0 h-screen
